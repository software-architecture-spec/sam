...
This document covers how to engage. The normative reference is [`v0.3/SPECIFICATION.md`](v0.3/SPECIFICATION.md). Section numbers below refer to that document.
