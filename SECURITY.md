...
- The SAM **specification text** ([`v0.3/SPECIFICATION.md`](v0.3/SPECIFICATION.md) and prior versions) — design flaws that weaken the threat model.
- The **JSON Schema** ([`v0.3/schema.json`](v0.3/schema.json) and prior versions) — bugs that let invalid manifests pass or that reject conforming ones.
